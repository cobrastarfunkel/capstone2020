...
public class LibraryTest {
	...
	public void testBfileExecution() {
		...
		assertTrue("C:\\eclipse\\test_files\\cpptest.txt Should be created",
				new File("C:\\eclipse\\test_files\\cpptest.txt").exists());
		...
		assertFalse("C:\\eclipse\\test_files\\cpptest.txt Should be deleted",
				new File("C:\\eclipse\\test_files\\cpptest.txt").exists());
	}
